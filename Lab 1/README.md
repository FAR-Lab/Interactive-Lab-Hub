...
_Setting:_ In any building: bedroom, kitchen, office space, etc. Outside in nature.

_Players:_ Residents of apertment buildings, houses, and office spaces. Painters navigating the world for natural color inspirations.

_Activity:_ Users hold up the device to a wall that needs to be repainted. They use the paint matching device to either match the current paint color of a wall for touch ups, or to save a color of someting natural.
...
I realized that there is a slight learning curve in terms of remembering all the functions of the crown button. This may be too confusing.

\*\***Are there new ideas that occur to you or your collaborators that come up from the acting?**\*\*

I changed my entire device to be a watch so it can be more portable. Collaborators also helped push me in the direction of removing the joystick, as well as implementing a touchscreen and instant color changes.
...
First Iteration:
![proto 1](https://user-images.githubusercontent.com/54602750/188564561-e0565ab2-8e2e-447d-9a69-6cbc6346127b.jpg)

This was my first iteration using the watch design. It was very helpful to think about my new design. I realized after drawing the prototype that I put the camera underneath the watch which would not work due to the users arm.

Second Iteration:
![proto2](https://user-images.githubusercontent.com/54602750/188564787-0c8e75a2-b7b7-4c71-8a7a-2d69f75c8764.jpg)

This design includes the camera in the correct location, the side of the watch.

Third Iteration:
![proto3](https://user-images.githubusercontent.com/54602750/188564966-511ef6e8-d78b-4584-886b-6f1ca5c74630.jpg)

This is my final iteration of my ePalette device. It includes a new idea where the crown can act as a button as well as a scroller for fine tuning and menu selection. This iteration also includes a vibrating mechanism that will alert the user when a color has been saved. This sketch also includes more descriptive use cases for the watch including how the color selection would work.

\*\***What concerns or opportunitities are influencing the way you've designed the device to look?**\*\*

I have decided to completely redesign the look of my device to improve its portability. This way users can take the device outside of their home. I've stripped the cosmetics from the design (the paintbrush look from the previous iterations) such that it will look stylish as a normal watch.
...
https://user-images.githubusercontent.com/54602750/188565790-d52026d5-ce3f-4e8a-8c06-8398c3ec2f08.mov


\*\***Please indicate anyone you collaborated with on this Lab.**\*\*

I worked with Jackson Riemer to get my first video of my original device. We discussed how to best set up a scene to act out a use case. I also took the comments from Michael Kelleher, Tyler Bershad, and Rahul Sahetiya into consideration while redesigning my device for Pt 2 of this lab.
