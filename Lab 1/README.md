...
Better: On the paper could show the specific scenario that the phone is uncharged and unable to reach. However, in the practical scenario, uncharged could not be show in a straight line. Also, the light is designed to set on until the call has been made, but it is hard to show that the light has been set on for a long time until the elders noticed.
...
<div align=center><img width="200" src="IMG_0231.jpeg"/></div>
