...
<img src="https://github.com/standardnormal/Interactive-Lab-Hub/blob/Fall2021/Lab%204/Sketches1.jpg?raw=true">
...
See part 2 area for documentation and photos. 
...
* "Looks like": The device looks like a flashlight with a button where a user would normally expect a button.
* "Works like": The device works like the color picker tool you'd find in a design app like Paint or Photoshop.
* "Acts like": Point the flashlight to something colorful and the device will find the RGB and hex codes for the color. If the user presses the button, the screen freezes so the user can record the color for use in their art projects.
