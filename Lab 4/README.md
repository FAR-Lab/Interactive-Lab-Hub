...
![sensor device ideas 1-2](https://user-images.githubusercontent.com/112603386/195507746-9319edda-9ea4-4d1b-99da-d3673c1dba0b.jpg)
![sensor device ideas 3-5](https://user-images.githubusercontent.com/112603386/195507754-bbfd1081-aea2-4daa-a28b-8a45a60d4e18.jpg)


**\*\*\*What are some things these sketches raise as questions? What do you need to physically prototype to understand how to anwer those questions?\*\*\***

Questions can be seen in above image.

**\*\*\*Pick one of these designs to prototype.\*\*\***

I will be combining idea 2 and 4 into one idea to prototype.
...
Future implementations of the device might include a game controller instead of individual pads. I would have to perform a few within-group user tests to see which style users preferred. I would also like to implement a drum beat as a backing track so the users have something to play along to so the melody feels more like a song. Even better would be to include an AUX/USB port in the back of the device so users can plug their phones in and play songs off of an app like Spotify, to use as a backing track. I would also like to have 8 pads per player in future iterations, so users can have a full scale to play around with. Another QWIIC button will also be used in future implementations to change the scale of the notes on the fly. 
