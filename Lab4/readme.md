...
0. Read through this week's lab.
...
* STATE DIAGRAMS: To sketch out how your interactive devices should act in different modes, we will be using state diagrams. Please review this tutorial on [Everything to Know about State Diagrams](https://www.smartdraw.com/state-diagram/)
* I2C: We've been using I2C since we first hooked up our OLED! The accelerometer and proximity sensor share the same communication bus. Here is a quick tutorial on how I2C works. http://www.mbeddedc.com/2017/05/i2c-bus-communication-protocol-tutorial.html

3. DESIGN READING: This is intended to help you understand what it means to prototype and test interactions: Bill Moggridge, Designing Interactions, (Chapter 10) http://www.designinginteractions.com/downloads/DesigningInteractions_10.pdf
