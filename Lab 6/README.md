...
**\*\*\*3. Build a working prototype of the system.\*\*\*** Do think about the user interface: if someone encountered these twizzlers that are connected to the sensor, would they know how to interact with them? Should they know what to expect?
