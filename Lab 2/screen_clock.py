...
#     display_image = white_background_image.copy()
#     display_image_evening = evening_image.copy()
#     display_image_afternoon = afternoon_image.copy()
#     # TODO: Lab 2 part D work should be filled in here. You should be able to look in cli_clock.py and stats.py 
#     # Get the current time in the format "mm/dd/yyyy hh:mm:ss"
#     date = time.strftime("%m/%d/%Y")
...
#     elif not buttonB.value:
#         x, y = 70, 80  # Adjust the coordinates as needed.
#         draw_on_image = ImageDraw.Draw(display_image_afternoon)
#         current_date = datetime.date.today()
#         day_name = current_date.strftime("%A")
#         draw_on_image.text((0, 0), "Today is", font=font2, fill="#FFFFFF")
#         draw_on_image.text((x, y), day_name, font=font, fill="#FFFFFF")
#         # Display the modified images with the time on the screen
#         disp.image(display_image_afternoon, rotation)
