...
3. Configure the Pi for [headless mode](https://www.raspberrypi.org/documentation/configuration/wireless/headless) . Create a file called "wpa_supplicant.conf"in the Boot image of the new disk. The file contents should have the following:
